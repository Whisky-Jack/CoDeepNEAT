        ...
        for parent in self.moduleNodeInputIDs:
            ...
            if (inputType is None):
                ...
                if (inputType == nn.Conv2d):
                    ...
                    numFeatures = self.getOutFeatures(deepLayer=parent.deepLayer)
            else:
                if (type(parent.deepLayer) == inputType):
                    ...
                    if (inputType == nn.Conv2d):
                        ...
                        newNumFeatures = self.getOutFeatures(deepLayer=parent.deepLayer)
                    ...
                    if (newNumFeatures == numFeatures):
                        ...
                        if (inputType == nn.Conv2d):
                            ...
                            if (not channels1 == channels2):
                                print("trying to merge two conv layers with differing numbers of channels :", channels1,
                                      channels2)
                                return
                            else:
                                if (x1 < x2):
                                    ...
                                    for i in range(len(inputs)):
                                        ...
                                        inputs[i] = F.pad(input=inputs[i], pad=(0, 0, leftPad, rightPad),
                    ...
                    print("trying to merge layers of different types:", type(parent.deepLayer), ";", inputType,
